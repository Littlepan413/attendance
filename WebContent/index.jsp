...
<body>
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				<a class="btn btn-navbar" data-toggle="collapse"
					...
					src="img/logo20.png" /> <span>Manage</span></a>
	...
	<div class="container-fluid">
			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-licon-homenk" href="index.jsp"><i
								class="icon-home"></i><span class="hidden-tablet"> 个人首页</span></a></li>
						<li><a class="ajax-link" href="index.jsp"><i
								class="icon-pencil"></i><span class="hidden-tablet"> 修改密码</span></a></li>
						<li class="nav-header hidden-tablet">日志查看</li>
						<li><a class="ajax-link" href="queryLogin"><i
								class="icon-edit"></i><span class="hidden-tablet"> 登陆日志</span></a></li>
						<li><a class="ajax-link" href="index.jsp"><i
		...
		<footer>
			<p class="pull-left">
				&copy; <a href="#" target="_blank">Muhammad Usman</a> 2014
			</p>
			<p class="pull-right">
				Powered by: <a href="#">Akichan</a>
			</p>
		</footer>
